...
describe("isBuiltinTool", () => {
  it("returns true for _morph_status", () => {
    expect(isBuiltinTool("_morph_status")).toBe(true);
  });
  it("returns true for _morph_toon_stats", () => {
    expect(isBuiltinTool("_morph_toon_stats")).toBe(true);
  });
  it("returns true for _morph_reload_config", () => {
    expect(isBuiltinTool("_morph_reload_config")).toBe(true);
  });
  it("returns false for regular tool names", () => {
    expect(isBuiltinTool("get_balance")).toBe(false);
  });
