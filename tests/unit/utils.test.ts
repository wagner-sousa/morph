...
import { MorphError, ConfigError, EnvResolutionError, MCPNotFoundError, ToolNotFoundError, ConflictError } from '../../src/utils/errors.js';
...
describe('EnvResolutionError', () => {
  it('extends MorphError with ENV_MISSING code and missing array', () => {
    const err = new EnvResolutionError('env vars missing: KEY1, KEY2', ['KEY1', 'KEY2']);
    expect(err).toBeInstanceOf(MorphError);
