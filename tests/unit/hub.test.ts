...
import { BUILTIN_TOOL_NAMES, isBuiltinTool } from '../../src/mcp-server/builtin-tools.js';
...
describe('callBuiltin — TOON conversion', () => {
  ...
  function createFullHub(): Hub {
    ...
    } as unknown as Hub['metrics'];
    (hub as any).reloadFromDisk = vi.fn();
